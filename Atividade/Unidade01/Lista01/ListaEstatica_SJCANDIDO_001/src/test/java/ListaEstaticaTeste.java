...
import com.mycompany.listaestatica_sjcandido_001.ListaEstatica_SJCANDIDO_001;
...
public class ListaEstaticaTeste {
    ...
    private ListaEstatica_SJCANDIDO_001 lista;

    @BeforeEach
    void setUp() {
        lista = new ListaEstatica_SJCANDIDO_001();
    }
